...
<div id="templatemo_header_wrapper">
    <div id="templatemo_header">
        ...
        <div id="site_title">
            <h1><a href="<?php echo e(url('/')); ?>" target="_parent"><strong>আমার ব্লগ</strong><span>সাম্প্রতিক বিস্ময়নের প্রতিচ্ছবি</span></a></h1>
        </div>
        ...
        <div id="templatemo_main_top">
            ...
            <div id="templatemo_sidebar">
                ...
                <ul class="templatemo_list">
                    ...
                    ?>
                        <li><a href="<?php echo e(URL::to('/popular_post')); ?>">Popular posts</a></li>
