        ...
        <div id="sidebar" class="nav-collapse collapse">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="{{url('/add_category')}}">Add Category</a></li>
                        <li><a class="" href="{{url('/manage_category')}}">Manage Category</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="{{url('/add_blog')}}">Add Blog</a></li>
                        <li><a class="" href="{{url('/manage_blog')}}">Manage Blog</a></li>
...
<script src="{{asset('public/admin_assets/')}}/js/respond.js"></script>
<![endif]-->
